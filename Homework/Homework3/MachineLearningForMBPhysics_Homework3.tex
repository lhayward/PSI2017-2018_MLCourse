...
In this homework assignment, you will write a blog-style article about research within the intersection of physics and machine learning.
...
%%%%%%%%%%%% OPTION 2 %%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Option 2: Write about your }
